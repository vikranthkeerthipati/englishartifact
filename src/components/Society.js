        ...
        return(
            ...
            <Jumbotron fluid style={inventionStyle}>
                ...
                <div style={{backgroundColor:"rgba(252,210,108,0.9)",marginTop:"5vh", padding:"4vh 4vh"}}>
                    <Button onClick={handleMShow}><h3>Witness the rise and fall of Mapleine!</h3></Button>                    
                </div>
        ...
        <Modal.Footer>
          <Button variant="secondary" onClick={handleMClose}>
            Close
                ...
                <div style={{backgroundColor:"rgba(252,210,108,0.9)",marginTop:"5vh", padding:"4vh 4vh"}}>
                    <Button onClick={handleMoShow}><h3>Experience mochi in the US!</h3></Button> 
            ...
            <Button variant="secondary" onClick={handleMoClose}>
                ...
                <div style={{backgroundColor:"rgba(252,210,108,0.9)",marginTop:"5vh", padding:"4vh 4vh"}}>
                    <Button onClick={handleAShow}><h3>The Evolution of Southern Food</h3></Button> 
